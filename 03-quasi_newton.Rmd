...
In a single iteration of the Nelder-Mead algorithm we seek to remove the matrix with the worst function value and replace it with another point with a better value.
